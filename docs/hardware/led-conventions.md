...
Физическая раскладка светодиодов по ячейке — [[playfield|Физическое игровое поле]].
...
Герой использует отдельную раскладку (см. [[playfield|Физическое поле]]): полоса здоровья `30` LED + полоса маны `10` LED.
...
Привязка анимаций к механикам фракций — см. [[_overview|обзор фракций]] и страницы конкретных фракций.
