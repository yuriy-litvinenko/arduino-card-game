...
- **Встраивание** в теле заметки той же строкой: `![[assets/art/.../<id>.png]]`. Путь во встраивании и в `art_image` должны совпадать.
...
![[assets/art/cards/minions/heat-boiler.png]]
...
Лор и эстетика фракций для описания субъекта — [[_overview|обзор фракций]].
